...
let tempMaterial: Cesium.Material | undefined = undefined;
...
export const IndoorView: React.FC<IndoorViewProps> = ({ globeController }) => {
    useEffect(() => {
        ...
        const leftClickHandler = (event: Cesium.ScreenSpaceEventHandler.PositionedEvent) => {
            ...
            if (pickedObject instanceof Cesium.Cesium3DTileFeature) {
                const extendedFeature = pickedObject as ExtendedCesium3DTileFeature;
                const tile = extendedFeature.content.tile;
                if (!tile || !tile.boundingSphere) return;
                startCartesian = tile.boundingSphere.center;
            ...
            if (!centerHeight || !startCartesian) return;
