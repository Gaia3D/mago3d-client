...
import { DefaultDrainageFeaturesFilter, DefaultDrainageFeaturesLayer, DefaultSoilFeaturesLayer, DefaultTownFeaturesFilter, DefaultTownFeaturesLayer, FilterLayerProps, FilterLayerState, ResultLayerDataType, ResultLayerStepType } from "@/recoils/Analysis";
 ...
 * 엄폐 분석
 */
const DefaultForestFeaturesLayer = '식생도';
const DefaultForestFeaturesFilter = `dmcls_cd IN ('1', '2', '3') OR dnst_cd IN ('A', 'B', 'C') OR storunst_cd = '0'`;

const DefaultSoilFeaturesFilter = `prrck_mddl_cd IN ('11', '21', '22', '23', '24', '25', '26', '27')`;
const Cover = () => {
  const analName = 'statistics:Cover';
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      <div className="analysisContent width-88">
        <label htmlFor="slopeCoverage">경사도
          ...
          <AnalHelp analName="Cover" propName="slopeCoverage"/>
        </label>
        <select 
          id="slopeCoverage" 
        ...
        <label htmlFor="forestFeatures">식생도(산림) 
          <span className="bullet-essential">*</span>
          <AnalHelp analName="Cover" propName="forestFeatures"/>
        </label>
        <select 
          id="forestFeatures" 
        ...
        <label htmlFor="soilFeatures">토질도 
          <span className="bullet-essential">*</span>
          <AnalHelp analName="Cover" propName="soilFeatures"/>
        </label>
        <select 
          id="soilFeatures" 
        ...
        <label htmlFor="townFeatures">도심지 
          <span className="bullet-essential">*</span>
          <AnalHelp analName="Cover" propName="townFeatures"/>
        </label>
        <select 
          id="townFeatures" 
        ...
        <label htmlFor="drainageFeatures">배수도
          <span className="bullet-essential">*</span>
          <AnalHelp analName="Cover" propName="drainageFeatures"/>
        </label>
        <select 
          id="drainageFeatures" 
        ...
        <label>분석 영역 <AnalHelp analName="Cover" propName="cropShape"/></label>
