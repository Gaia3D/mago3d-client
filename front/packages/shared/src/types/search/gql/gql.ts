 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query BMKPT_SEARCH($filter: BmkptSearchFilter) {\n  bmkptSearch(filter: $filter) {\n    items {\n      id\n      name\n      lat\n      lon\n    }\n  }\n}\n\nquery ADDRESS_SEARCH($filter: AddressSearchFilter) {\n  addressSearch(filter: $filter) {\n    items {\n      id\n      sidoName\n      sggName\n      emdName\n      bldMnnm\n      bldSlno\n      roadName\n      roadAddr\n      lat\n      lon\n    }\n  }\n}\n\nquery UNSPT_SEARCH($filter: UnsptSearchFilter) {\n  unsptSearch(filter: $filter) {\n    items {\n      id\n      name\n      lat\n      lon\n    }\n  }\n}\n\nquery TRIPT_SEARCH($filter: TriptSearchFilter) {\n  triptSearch(filter: $filter) {\n    items {\n      id\n      name\n      lat\n      lon\n    }\n  }\n}"): (typeof documents)["query BMKPT_SEARCH($filter: BmkptSearchFilter) {\n  bmkptSearch(filter: $filter) {\n    items {\n      id\n      name\n      lat\n      lon\n    }\n  }\n}\n\nquery ADDRESS_SEARCH($filter: AddressSearchFilter) {\n  addressSearch(filter: $filter) {\n    items {\n      id\n      sidoName\n      sggName\n      emdName\n      bldMnnm\n      bldSlno\n      roadName\n      roadAddr\n      lat\n      lon\n    }\n  }\n}\n\nquery UNSPT_SEARCH($filter: UnsptSearchFilter) {\n  unsptSearch(filter: $filter) {\n    items {\n      id\n      name\n      lat\n      lon\n    }\n  }\n}\n\nquery TRIPT_SEARCH($filter: TriptSearchFilter) {\n  triptSearch(filter: $filter) {\n    items {\n      id\n      name\n      lat\n      lon\n    }\n  }\n}"];
