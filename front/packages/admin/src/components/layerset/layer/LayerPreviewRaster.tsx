...
const LayerPreviewRaster = ({asset}:{asset:LayerAsset}) => {
    ...
    useEffect(() => {
        ...
        const imageLayer = getWmsLayer(resource.name);
        viewer.imageryLayers.add(imageLayer);
        imageLayerRef.current = imageLayer;

        const {minx, maxx, miny, maxy, crs} = data.remote.coverage.latLonBoundingBox;
...
export default LayerPreviewRaster;