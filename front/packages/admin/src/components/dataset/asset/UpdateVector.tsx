...
import {assetVectorTypeOptions} from "./constant";
...
const UpdateVector = () => {
  ...
  // const asset = useFragment(DataAssetInfoFragmentDoc, data.asset);
          ...
          <div style={{display: "inline-block"}}>
            ...
            <label htmlFor="data-update-3d-asset-type">데이터 타입</label>
            {
              asset?.assetType ? <select
                ...
                >
                  {
                    assetVectorTypeOptions.map((item) => {
                      return (
