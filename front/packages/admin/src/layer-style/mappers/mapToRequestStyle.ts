...
export const mapToRequestStyle = (editable: EditableStyleModel): StyleContextValue => {
...
const mapToRuleStyleContext = (style: EditableStyleModel): RuleStyleContextValue => {
  const buildLabel = () => {
