...
const RasterEntryTableValue = ({context, onChange}: RasterEntryTableValueProps) => {
  ...
  const addEntry = () => {
    const baseValue = entries.length >= 2
      ? entries[entries.length - 1]?.bandValue ?? 0
      : 0;
...
export default RasterEntryTableValue;